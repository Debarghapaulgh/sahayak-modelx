...
PROMPT_TEMPLATES = [
    ("math_worksheet_5q", "সহায়ক এআই, এই পাঠ্যাংশের গাণিতিক সূত্রের উপর ভিত্তি করে মাধ্যমিক উপযোগী ৫টি অংক ও তাদের সম্পূর্ণ ধাপভিত্তিক সমাধানসহ একটি ওয়ার্কশীট তৈরি করে দিন।"),
    ("math_step_solution", "সহায়ক এআই, মাধ্যমিক পরীক্ষার মানের ৩টি গাণিতিক সমস্যা (পাটিগণিত/বীজগণিত/পরিমিতি) প্রদান করুন এবং প্রতিটি প্রশ্নের সহজ বাংলা ভাষায় নির্ভুল ধাপে ধাপে সমাধান লিখুন।"),
    ("theorem_explain", "সহায়ক এআই, এই অংশের বৃত্ত/পিথাগোরাস সংক্রান্ত উপপাদ্যটি সহজ ভাষায় বুঝিয়ে দিন এবং এর থেকে আসা ২টি প্রয়োগ ও উত্তর ব্যাখ্যা করুন।"),
    ("mcq_math_quiz", "সহায়ক এআই, পশ্চিমবঙ্গ মাধ্যমিক গণিত পরীক্ষার উপযুক্ত ৪টি এমসিকিউ (MCQ) প্রশ্ন তৈরি করে উত্তরপত্রের সঠিক গাণিতিক ব্যাখ্যা প্রস্তুত করুন।"),
    ("student_math_doubt", "সহায়ক এআই, এই অনুচ্ছেদের অংকটি আমার কাছে কঠিন লাগছে। প্রাত্যহিক বাস্তব জীবনের উদাহরণ দিয়ে ধাপে ধাপে অংকটি সমাধান করে দিন।"),
    ("mensuration_trig_broad", "সহায়ক এআই, মাধ্যমিক পরীক্ষার উপযোগী ১টি ৫ নম্বর মানের পরিমিতি / ত্রিকোণমিতি / রাশিবিজ্ঞানের বড় অংক ও তার সম্পূর্ণ পরিচ্ছন্ন সমাধান প্রদান করুন।")
]

SYSTEM_PREAMBLE = """তুমি 'সহায়ক এআই' (SahayakAI) — পশ্চিমবঙ্গ মধ্যশিক্ষা পর্ষদের (WBBSE - মাধ্যমিক) দশম শ্রেণির গণিত (Ganit Prakash Class X) শিক্ষার জন্য এক অত্যন্ত অভিজ্ঞ, ধৈর্যশীল ও বিশেষ শিক্ষণ সাহায্যকারী AI টিউটর।
...
২. শিক্ষক মহাশয় / অভিভাবকের উদ্দেশ্যে সহায়ক এআই-এর উত্তর: যখন শিক্ষক মহাশয়কে পাঠ পরিকল্পনা বা মূল্যায়ন দেওয়া হবে, তখন সর্বদা শ্রদ্ধাসূচক বাক্যাংশ ব্যবহার করবে ('আপনি' সম্বোধন: 'করুন', 'প্রদান করছি')।
৩. শিক্ষার্থীদের উদ্দেশ্যে সহায়ক এআই-এর টিউটরিং / শিক্ষা প্রদান: যখন শিক্ষার্থীকে কোনো গণিত বা উপপাদ্য শেখাবে, তখন সর্বদা সহজ, বন্ধুভাবাপন্ন ও প্রাত্যহিক বাক্য ব্যবহার করবে ('তুমি/তোমরা' সম্বোধন: 'লেখো', 'এসো সমাধান করি', 'মনে রাখবে')।
...
সহায়ক এআই (SahayakAI) ডব্লিউবিবিএসই (WBBSE) দশম শ্রেণি গণিত প্রকাশ বিবরণী:
